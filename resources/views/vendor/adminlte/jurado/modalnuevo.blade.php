<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-nuevo-jurado">
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h5 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Crear Nuevo Jurado</h5>
          </div>
          <div class="modal-body">
            <form class="" action="{{route('jurado.store')}}" method="post">
              @csrf
                  <div class="row">

<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-periodo-{{ $periodo->id }}">
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-edit"></i> Editar - Periodo {{$periodo->ano}} {{$periodo->periodo}}</h4>
          </div>
          <div class="modal-body">
            <form class="" action="{{route('periodos.update', $periodo->id)}}" method="post">
              @csrf
                <div class="row">
                      ...
                      <div class="col-sm-3 col-xs-12">
                          <div class="form-group{{ $errors->has('ano') ? ' has-warning' : '' }}">
                              ...
                              @endif
                              <input class="form-control" name="ano" type="text" value="{{$periodo->ano}}" />
                              @if ($errors->has('ano'))
                                  <span class="help-block">
                      ...
                      <div class="col-sm-3 col-xs-12">
                          <div class="form-group{{ $errors->has('acronimo') ? ' has-warning' : '' }}">
                              ...
                              @endif
                              <input class="form-control" name="periodo" type="text" value="{{$periodo->periodo}}" />
                              @if ($errors->has('periodo'))
                                  <span class="help-block">
                      ...
                      <div class="col-sm-4 col-xs-12">
                          <div class="form-group{{ $errors->has('estado') ? ' has-warning ' : '' }}">
                              ...
                              <select id="selectEstado" class="form-control" name="estado">
                                  <option value="en curso" @if($periodo == 'en curso') selected @endif>En Curso</option>
                                  <option value="concluido" @if($periodo == 'concluido') selected @endif>Concluido</option>
                              </select>
                          </div>
                      </div>
                    </div>
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                        ...
                        <button class="btn btn-app bg-green" type="button" data-target="#modal-validation-{{$periodo->id}}" data-toggle="modal">
                            <i class="fa fa-save"></i> Guardar
                        </button>
                        <div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-validation-{{$periodo->id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">

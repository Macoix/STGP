<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-comite-{{$comite->comite_id}}">
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="" action="{{route('comite.update', $comite->comite_id)}}" method="post">
              @csrf
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                        ...
                        <button class="btn btn-app bg-green" type="button" data-target="#modal-validation-{{$comite->comite_id}}" data-toggle="modal">
                            <i class="fa fa-save"></i> Guardar
                        </button>
                        <div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-validation-{{$comite->comite_id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">

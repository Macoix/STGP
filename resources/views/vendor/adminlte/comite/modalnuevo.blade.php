<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-nuevo-comite">
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h5 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Crear Nuevo Miembro Comite</h5>
          </div>
          <div class="modal-body">
            <form class="" action="{{route('comite.store')}}" method="post">
              @csrf
                  <div class="row">
